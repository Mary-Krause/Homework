...
class Figure:
    ...
    def __init__(self, color, *sides):
        ...
        self.filled = True
        self.__sides = list(sides) if self.__is_valid_sides(*sides) and len(sides) == self.sides_count else [
                                                                                                                1] * self.sides_count
...
class Cube(Figure):
    ...
    def __init__(self, color, *sides):
        side_length = sides[0] if len(sides) == 1 and self.__is_valid_sides(*sides) else 1
